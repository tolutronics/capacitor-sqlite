...
@CapacitorPlugin(name = "TolutronicsCapacitorSqlite")
public class TolutronicsCapacitorSqlitePlugin extends Plugin {

  private TolutronicsCapacitorSqlite implementation;
  ...
  public void load() {
    context = getContext();
    implementation = new TolutronicsCapacitorSqlite(context);
  }
