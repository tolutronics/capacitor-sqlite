package com.tolutronics.plugin.capacitor.tolutronicscapacitorsqlite;

import android.content.Context;
import com.getcapacitor.JSObject;
import com.tolutronics.plugin.capacitor.tolutronicscapacitorsqlite.cdssUtils.Data;
import com.tolutronics.plugin.capacitor.tolutronicscapacitorsqlite.cdssUtils.ImportExportJson.JsonStore;
import com.tolutronics.plugin.capacitor.tolutronicscapacitorsqlite.cdssUtils.ImportExportJson.JsonTable;
import com.tolutronics.plugin.capacitor.tolutronicscapacitorsqlite.cdssUtils.StorageDatabaseHelper;
import java.io.File;
import java.util.ArrayList;
import java.util.List;

public class TolutronicsCapacitorSqlite {

  private StorageDatabaseHelper mDb;
  private Context context;

  public TolutronicsCapacitorSqlite(Context context) {
