...
import { TolutronicsCapacitorSqlite } from '@tolutronics/capacitor-sqlite';
...
export class StoreService {
  ...
  async init(): Promise<void> {
    ...
    this.store = TolutronicsCapacitorSqlite;
    this.isService = true;
...
export class TeststoreComponent implements AfterViewInit {
  ...
  async ngAfterViewInit() {
    ...
    // Initialize the TolutronicsCapacitorSqlite plugin
...
} from "@tolutronics/capacitor-sqlite";

export let sqlStore = TolutronicsCapacitorSqlite;
