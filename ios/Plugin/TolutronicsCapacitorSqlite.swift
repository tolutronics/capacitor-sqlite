...
enum TolutronicsCapacitorSqliteError: Error {
    case failed(message: String)
}

// swiftlint:disable file_length
// swiftlint:disable type_body_length
@objc public class TolutronicsCapacitorSqlite: NSObject {
    ...
    @objc func openStore(_ dbName: String, tableName: String,
        ...
        do {
            ...
            throw TolutronicsCapacitorSqliteError
    ...
    @objc func isJsonValid(_ parsingData: String) throws {
        ...
        if let data = ("["+parsingData+"]").data(using: .utf8) {
            do {
                ...
                throw TolutronicsCapacitorSqliteError.failed(message: msg)
            }
        } else {
    ...
    throws -> [String: Any] {
        if mDb != nil {
            do {
                ...
                throw TolutronicsCapacitorSqliteError.failed(message: message)
            } catch let error {
                let msg: String = "\(error.localizedDescription)"
                throw TolutronicsCapacitorSqliteError.failed(message: msg)
            }
