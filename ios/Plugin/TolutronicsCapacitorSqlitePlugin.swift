...
@objc(TolutronicsCapacitorSqlitePlugin)
public class TolutronicsCapacitorSqlitePlugin: CAPPlugin, CAPBridgedPlugin {
    public let identifier = "TolutronicsCapacitorSqlitePlugin"
    public let jsName = "TolutronicsCapacitorSqlite"
    ...
    private let implementation = TolutronicsCapacitorSqlite()
    ...
    @objc func openStore(_ call: CAPPluginCall) {
        ...
        do {
            ...
            return
        } catch TolutronicsCapacitorSqliteError
                    .failed(let message) {
    ...
    @objc func closeStore(_ call: CAPPluginCall) {
        ...
        do {
            ...
            retHandler.rResult(call: call)
            return
        } catch TolutronicsCapacitorSqliteError.failed(let message) {
